        ...
        >
            ...
            <Stack minHeight={'460px'} zIndex={100} justifyContent={'flex-end'} alignItems={'flex-start'}
                ...
                <Stack sx={{ borderLeft: '2px solid #1E6EA1' }} mb={8}>
                    ...
                    <Typography variant='h5' color={'#fff'} px={2} textAlign={'left'} maxWidth={'600px'} lineHeight={'16px'} fontWeight={300}>
            ...
            <Stack sx={{
                ...
                <Stack sx={{ maxWidth: '1200px', mx: 'auto', px: { lg: 4, md: 4, sm: 3, xs: 3 } }}>
                    <Typography fontSize={14} color={'secondary.main'} fontWeight={300}>
                    ...
                    <Typography fontSize={14} color={'secondary.main'} fontWeight={300} pl={1} pt={0} lineHeight={'20px'}>
